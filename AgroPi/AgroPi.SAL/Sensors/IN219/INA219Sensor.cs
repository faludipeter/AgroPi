...
namespace AgroPi.SAL.Sensors.IN219
{
    /// <summary>
    ...
    /// </summary>
    public class INA219Sensor : IDisposable
    {
        ...
        public INA219Sensor(I2cDevice i2cDevice)
        {
            if (i2cDevice == null)
            {
        ...
        public INA219Sensor(I2cConnectionSettings settings)
        {
            if (settings == null)
            {
