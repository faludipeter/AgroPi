using AgroPi.SAL.Sensors.TSL2591.GainMode;
using AgroPi.SAL.Sensors.TSL2591.IntegrationTimeMode;
using AgroPi.SAL.Sensors.TSL2591.Register;
using System;
using System.Collections.Generic;
using System.Device.I2c;
using System.Text;

namespace AgroPi.SAL.Sensors.TSL2591
{
    /// <summary>
    ...
    public class TSL2591Sensor : IDisposable
    {
        ...
        {
            get { return _TSL2591IntegrationTimeMode; }
            set
            {
        ...
        public float GetLux()
        {
            ...
            {
                throw new Exception("TSL2591 sensor overflow");
            }
